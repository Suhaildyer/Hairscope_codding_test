...
//       if (direction === "right" && newCol < techGrid[0].length - 1) newCol++;
...
//       {/* Sidebar */}
//       <div className="w-1/4 p-6 border-r border-cyan-400 flex flex-col items-center space-y-8">
//         <select className="bg-black border border-cyan-400 text-cyan-400 p-2 rounded w-full">
...
//           <button
//             className="p-3 border border-cyan-400 rounded"
...
//          className="bg-cyan-400 text-black px-6 py-3 rounded font-bold hover:bg-cyan-300">
//           Enter Labs
//         </button>
//       </div>
...
//         <div className="grid grid-cols-5 gap-4 p-8 bg-gray-900 rounded-xl border-4 border-cyan-400 relative">
...
//                   className="w-32 h-24 flex items-center justify-center border-2 border-cyan-400 bg-black relative"
//                 >
//                   {tech ? (
//                     <img onClick={()=>setShowMaze(true)} src={techLogos[tech]} alt={tech} className="w-12 h-12" />
//                   ) : (
    ...
    <>
      <div className="min-h-screen bg-black text-white flex flex-col md:flex-row  " >
        ...
        <div className="w-full md:w-1/4 p-4 md:p-6 border-b md:border-b-0 md:border-r border-cyan-400 flex flex-col md:items-between justify-around space-y-4 md:space-y-8 ">
          ...
          <div className="flex flex-col items-center space-y-2 ">
            <button
              className="p-2 md:p-3 border border-cyan-400 rounded"
              onClick={() => movePacman("up")}
              aria-label="Move Up"
            >
              <FaArrowUp />
          ...
          <button
            onClick={() => setShowMaze(true)}
            className="bg-cyan-400 text-black px-4 md:px-6 py-2 md:py-3 rounded font-bold hover:bg-cyan-300 w-full md:w-auto "
          >
            Enter Labs
          </button>
        </div>
              ...
              row.map((tech, colIndex) => {
                ...
                return (
                  <div
                     onClick={() => setShowMaze(true)}
                    key={`${rowIndex}-${colIndex}`}
                    className="min-w-[50px] aspect-square sm:w-20 md:w-32 flex items-center justify-center border-2  bg-black relative rounded-lg "
                  >
                    {tech ? (
                      <img
